    ...
    <main id="main">
        ...
        <section id="tambah" class="tambah section-bg"><br>
            <div class="card shadow mb-4">
                ...
                <form method="POST" action="<?= base_url('admin/gfr/' . $gfr['id_gfr'] . '/edit') ?>" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="nama_keypoint" required>
                                ...
                                ?>
                                    <option value="<?= $relay['id_relay'] ?>" <?= $gfr['id_relay'] == $relay['id_relay'] ? 'selected' : "" ?>>
                                        <?= $relay['nama_keypoint'] ?>
                                    </option>
                                <?php
                                }
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col">
                                <div class="mb-2">
                                    ...
                                    <input type="number" class="form-control" aria-label="First name" name="gfr_arus_1" step="0.0000001" value="<?= $gfr['gfr_arus_1'] ?>">
                                </div>
                                <div class="mb-2">
                                    <label for="small mb-1 label-width" for="unit">TMS</label>
                                    <input type="number" class="form-control" aria-label="First name" name="gfr_tms" step="0.0000001" value="<?= $gfr['gfr_tms'] ?>">
                                </div>
                                <div class="mb-2">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="gfr_curva_1">
                                        <option selected value="<?= $gfr['gfr_curva_1'] ?>"><?= $gfr['gfr_curva_1'] ?></option>
                            ...
                            <div class="col">
                                <div class="mb-2">
                                    ...
                                    <input type="number" class="form-control" aria-label="First name" name="gfr_arus_2" step="0.0000001" value="<?= $gfr['gfr_arus_2'] ?>"> 
                                </div>
                                <div class="mb-2">
                                    <label for="small mb-1 label-width" for="unit">TD</label>
                                    <input type="number" class="form-control" aria-label="First name" name="gfr_td" step="0.0000001" value="<?= $gfr['gfr_td'] ?>">
                                </div>
                                <div class="mb-2">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="gfr_curva_2">
                                        <option selected value="<?= $gfr['gfr_curva_2'] ?>"><?= $gfr['gfr_curva_2'] ?></option>
                                        <option value="SI">SI</option>
                                        <option value="VI">VI</option>
                                        <option value="EI">EI</option>
                                        <option value="UI">UI</option>
                            ...
                            <div class="col">
                                <div class="mb-2">
                                    ...
                                    <input type="number" class="form-control" aria-label="First name" name="gfr_arus_3" step="0.0000001" value="<?= $gfr['gfr_arus_3'] ?>">
                                </div>
                                <div class="mb-2">
                                    <label for="small mb-1 label-width" for="unit">Delay</label>
                                    <input type="number" class="form-control" aria-label="First name" name="gfr_delay" step="0.0000001" value="<?= $gfr['gfr_delay'] ?>">
                                </div>
                                <div class="mb-2">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="gfr_curva_3">
                                        <option selected value="<?= $gfr['gfr_curva_3'] ?>"><?= $gfr['gfr_curva_3'] ?></option>
                                        <option value="SI">SI</option>
                                        <option value="VI">VI</option>
                                        <option value="EI">EI</option>
                                        <option value="UI">UI</option>
