    ...
    <main id="main">
        ...
        <section id="tambah" class="tambah section-bg"><br>
            <div class="card shadow mb-4">
                ...
                <form method="POST" action="<?= base_url('admin/ulp/' . $ulp['id_ulp'] . '/edit') ?>" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="nama_up" required>
                                ...
                                foreach ($up as $up) {
                                ?>
                                    <option value="<?= $up['id_up'] ?>" <?= $ulp['id_up'] == $up['id_up'] ? 'selected' : "" ?>>
                                        <?= $up['nama_up'] ?>
                                    </option>
                                <?php
                                }
                        ...
                        <div class="mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" placeholder="Masukkan Nama ULP" name="nama_ulp" value="<?= $ulp['nama_ulp'] ?>" required>
                            </div>
                        </div>
