                ...
                <table id="example" class="table" style="width:100%; margin-top: 20px;">
                    <thead>
                        <tr>
                            ...
                            <th class="table-info">Nama Alat</th>
                            <th class="table-info">Status Alat</th>
                            <th class="table-info">Urutan Keypoint (Pemutus)</th>
                            <th class="table-info">Keypoint (Pemutus)</th>
                            <th class="table-info">Rasio CT Primer</th>
                            <th class="table-info">Rasio CT Sekunder</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $relay['nama_relay'] ?></td>
                                <td><?= $relay['status_relay'] ?></td>
                                <td><?= $relay['urutan_keypoint'] ?></td>
                                <td><?= $relay['nama_keypoint'] ?></td>
